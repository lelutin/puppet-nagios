class nagios::nrpe::base {
    ...
    $real_processorcount = $::processorcount ? {
      ''      => 1,
    ...
    $warning_1_threshold = 7 * $real_processorcount
    $warning_5_threshold = 6 * $real_processorcount
    $warning_15_threshold = 5 * $real_processorcount
    $critical_1_threshold = 10 * $real_processorcount
    $critical_5_threshold = 9 * $real_processorcount
    $critical_15_threshold = 8 * $real_processorcount
